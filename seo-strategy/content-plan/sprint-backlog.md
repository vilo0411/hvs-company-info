# Sprint Backlog — HVS SEO

> Cập nhật bởi `/keyword-plan` (thêm item) và `/write --sprint` (generate outline).  
> Status flow: `Planned` → `Outline-Pending` → `Outline-Approved` → *(xóa khi Finalize)*
...
| 276 | bẫy thanh khoản | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 277 | capex là gì | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 278 | chi phí cố định | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 279 | chiến lược thị trường là gì | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 280 | chu kỳ có nghĩa là gì | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 281 | chu kỳ cổ phiếu | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 282 | chuỗi giá trị ngành bất động sản | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 283 | chuỗi giá trị ngành cao su | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 284 | chuỗi giá trị ngành dầu khí | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 285 | chuỗi giá trị ngành dệt may | Phân tích cơ bản | F0 | Priority 1 | Planned |
| 286 | chuỗi giá trị ngành ngân hàng | Phân tích cơ bản | F0 | Priority 1 | Planned |
