...
Target_Keyword: Có nên mua cổ phiếu POW
Secondary_Keywords: đánh giá cổ phiếu pow, tiềm năng cổ phiếu pow, phân tích cổ phiếu pow
LSI_Keywords: sàn HOSE, cổ phiếu phòng thủ, PV Power, Tổng công ty Điện lực Dầu khí Việt Nam, ngành điện, điện khí LNG, nhà máy Nhơn Trạch 3 và 4, tỷ suất cổ tức, nhiệt điện, EVN
Niche_Context: Stock Analysis | Defensive Stocks
Entities: POW, PV Power, Nhơn Trạch 3, Nhơn Trạch 4, EVN, HOSE, HVS
Entities_Gap_Analysis: Phân tích thực tế về triển vọng dự án Nhơn Trạch 3 & 4 (nhà máy điện khí LNG đầu tiên tại Việt Nam), vấn đề công nợ tiền điện chậm thanh toán từ EVN và đặc tính phòng thủ của nhóm cổ phiếu tiện ích điện nước
Search_Intent: Commercial | Transactional
Search_Intent_Deep: Người đọc đang tìm kiếm một bài đánh giá phân tích chi tiết, khách quan về cổ phiếu POW (PV Power) để quyết định xem có nên giải ngân mua cổ phiếu này vào danh mục đầu tư trung và dài hạn hay không.

# Strategic Guardrails
Persona: HVS Senior Mentor
Tone_Style: Direct, Data-driven, Objective
Lexicon_Focus: cổ phiếu phòng thủ, điện khí LNG, biên lợi nhuận gộp, tỷ suất cổ tức, chu kỳ đầu tư
Financial_Logic: Scenario-based (Nếu dự án Nhơn Trạch 3 và Nhơn Trạch 4 đi vào vận hành thương mại đúng tiến độ trong năm tới và dòng tiền từ EVN được giải quyết hanh thông, doanh thu của POW sẽ bứt phá mạnh mẽ. Ngược lại, nếu giá khí hóa lỏng LNG nhập khẩu duy trì ở mức cao và sản lượng huy động từ EVN thấp do hạn chế truyền tải, biên lợi nhuận gộp của POW tiếp tục chịu áp lực lớn), Risk-Reward
Avoid_Mistakes: Không dùng từ cấm "trong thế giới không ngừng phát triển", "hành trình đầu tư", "giải pháp toàn diện". Tránh lạm dụng ngoặc kép để nhấn mạnh cảm xúc.
...
Direct_Answer_Targets:
  - heading: "H2: Kịch bản định giá và quyết định có nên mua cổ phiếu POW?"
    type: "Definition / Direct Answer"
    bold_target: "Có nên mua cổ phiếu POW phụ thuộc vào trường phái đầu tư của bạn, nếu bạn tìm kiếm một cổ phiếu phòng thủ có dòng tiền ổn định và kỳ vọng tăng trưởng dài hạn từ dự án điện khí Nhơn Trạch 3 và 4 thì POW là lựa chọn giải ngân phù hợp khi giá về vùng chiết khấu sâu"
...
# Cluster info
Cluster: Có nên mua cổ phiếu
Internal_Links:
  - role: Pillar
    file: Outline-cach-mua-co-phieu-shb.md
    anchor_suggestion: "cách mua cổ phiếu SHB"
---

# Có nên mua cổ phiếu POW: Triển vọng điện khí và thách thức tài chính thực tế
...
| Chỉ số tài chính & Kịch bản | Kịch bản Tích cực (Nhơn Trạch 3 & 4 đúng hạn) | Kịch bản Thận trọng (Tiến độ trễ, EVN nợ đọng) |
| :--- | :--- | :--- |
| **Tiến độ dự án** | NT3 phát điện thương mại đúng tiến độ năm tới; NT4 hoạt động tiếp nối sau 6 tháng. | Tiến độ chậm 6-12 tháng do vướng mắc hạ tầng truyền tải và hợp đồng mua bán điện PPA. |
| **Dòng tiền từ EVN** | EVN thanh toán 40-50% công nợ quá hạn, POW giảm dư nợ vay ngắn hạn. | EVN tiếp tục chậm thanh toán, số dư phải thu duy trì ở mức trên 12.000 tỷ đồng. |
