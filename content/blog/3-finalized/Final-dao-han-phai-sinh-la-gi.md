...
Target_Keyword: đáo hạn phái sinh là gì
Secondary_Keywords: ngày đáo hạn phái sinh, đáo hạn phái sinh, cách tính giá thanh toán cuối cùng phái sinh, ảnh hưởng của ngày đáo hạn phái sinh
LSI_Keywords: VN30F1M, VN30F2M, VN30F1Q, VN30F2Q, đảo vị thế, rollover, chênh lệch giá mua-bán, arbitrage, hội tụ giá, lệnh rổ chỉ số, Hợp đồng tương lai, chỉ số VN30, phiên ATC, giá thanh toán cuối cùng, FSP, thị trường cơ sở, tất toán vị thế, biến động giá, VSD
Niche_Context: Securities Trading | Derivatives
Entities: VN30F1M, VN30F2M, VN30F1Q, VN30F2Q, Hợp đồng tương lai, chỉ số VN30, ngày đáo hạn, giá thanh toán cuối cùng, FSP, phiên ATC, thị trường cơ sở, VN30-Index, Trung tâm Lưu ký Chứng khoán, VSD, Arbitrage, Rollover
Entities_Gap_Analysis: Phân tích kỹ lưỡng quy tắc tính giá thanh toán cuối cùng (FSP) mới nhất từ tháng 6/2022 (loại bỏ 3 mức giá trị chỉ số cao nhất và thấp nhất trong 30 phút cuối ngày giao dịch); cơ chế tất toán tự động bằng tiền mặt của VSD; cơ chế đảo vị thế (Rollover) giữa các kỳ hạn phái sinh; hoạt động kinh doanh chênh lệch giá (Arbitrage) và sự hội tụ giá; ảnh hưởng của lệnh rổ chỉ số (Basket Orders) của khối ngoại/tự doanh trong phiên ATC để tránh bẫy tâm lý.
Search_Intent: Informational
Search_Intent_Deep: Lan Newbie nghe các hội nhóm bàn tán về rủi ro ngày đáo hạn phái sinh gây biến động mạnh, muốn tìm hiểu bản chất đáo hạn phái sinh là gì, cách tính toán giá thanh toán để phòng vệ danh mục đầu tư cơ sở của mình, tránh đưa ra quyết định mua bán sai lầm do hoảng loạn.
Word_Count_Target: 2200

# Strategic Guardrails (Professionalism & Memory)
Persona: HVS Senior Mentor
Tone_Style: Direct, Data-driven, Objective
Lexicon_Focus: Hợp đồng tương lai, chỉ số VN30, ngày đáo hạn, giá thanh toán cuối cùng, phiên ATC, thị trường cơ sở, nhà đầu tư, quản trị rủi ro, phân tích kỹ thuật
Financial_Logic: Scenario-based (Kịch bản biến động thị trường cơ sở trong phiên ATC ngày đáo hạn phái sinh), Risk-Reward (Mối tương quan giữa phòng vệ danh mục bằng phái sinh và rủi ro đòn bẩy cao), non-recommendation.
...
Direct_Answer_Targets:
  - heading: "H2: Đáo hạn phái sinh là gì?"
    type: "Definition / Direct Answer"
    bold_target: "ngày giao dịch cuối cùng của hợp đồng tương lai"
...
1. Ghi nhận toàn bộ giá trị chỉ số VN30-Index được công bố mỗi giây một lần trong 15 phút của phiên khớp lệnh liên tục từ 14:00 đến 14:15 và toàn bộ giá trị VN30-Index trong 15 phút của phiên khớp lệnh định kỳ đóng cửa ATC từ 14:15 đến 14:30.
2. Sắp xếp toàn bộ chuỗi dữ liệu giá trị chỉ số thu được trong phiên liên tục (14:00 - 14:15) và thực hiện loại bỏ chính xác 3 giá trị chỉ số lớn nhất cùng 3 giá trị chỉ số nhỏ nhất.
3. Tính trung bình số học giản đơn của tất cả các giá trị chỉ số VN30 còn lại trong phiên liên tục kết hợp với toàn bộ dữ liệu chỉ số thu được trong phiên ATC để đưa ra giá đóng cửa FSP cuối cùng.
...
Ngày đáo hạn phái sinh tác động đến thị trường chứng khoán cơ sở thông qua **hoạt động kinh doanh chênh lệch giá (Arbitrage Trading) của các tổ chức và các lệnh mua bán lô lớn (Basket Orders) rổ VN30 tại ATC** để đẩy chỉ số về vùng giá có lợi cho vị thế phái sinh. Sự liên thông chặt chẽ giữa hai thị trường tạo nên những chuyển động đặc thù vào ngày Thứ Năm lần thứ ba của tháng.
...
Kết luận ngày đáo hạn phái sinh là sự kiện định kỳ tạo ra cơ hội và rủi ro ngắn hạn, đòi hỏi bạn phải có **kiến thức phân tích vững vàng và tính kỷ luật vốn cao** khi đồng hành cùng HVS. Việc hiểu rõ luật chơi và chủ động lên kịch bản quản lý vị thế sẽ giúp bạn đứng vững trước những nhịp rung lắc kỹ thuật của thị trường. Hãy tiếp tục nâng cao năng lực đầu tư của bản thân cùng các chương trình đào tạo chuyên sâu của HVS để xây dựng sự nghiệp tài chính bền vững.

## Nhật ký chỉnh sửa (Revision Log)
- **v1.0 (2026-06-23):** Khởi tạo outline cho từ khóa "đáo hạn phái sinh là gì" theo yêu cầu viết bài trong sprint backlog.
- **v1.1 (2026-06-29):** Tối ưu hóa cấu trúc outline dựa trên phân tích bài viết đối thủ (Vietcap); điều chỉnh độ dài H1 chuẩn SEO (≤65 ký tự); tinh chỉnh Sapo chứa chính xác keyword chính và thương hiệu HVS; bổ sung cấu trúc H3 cho cơ chế đảo vị thế (Rollover), giãn spread, giao dịch chênh lệch giá (Arbitrage) và tác động của lệnh rổ (Basket Orders).
- **v1.2 (2026-06-29):** Biên soạn bản thảo (Draft) hoàn chỉnh theo quy trình phê duyệt Express; tinh chỉnh nội dung HVS Bridge liên quan đến sản phẩm HVS Demo chỉ hỗ trợ giao dịch giả lập cổ phiếu cơ sở.
